...
export default function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Streamline | Privacy Policy</title>
      </Head>
      <Container>
        <Heading>Privacy Policy</Heading>
        <Paragraph>Last updated: July 09, 2023</Paragraph>
        <Paragraph>
        ...
        <List>
          ...
          <ListItem>
            <strong>Website</strong> refers to Streamline, accessible from{' '}
            <a href="https://app.devnetwork.tech" target="_blank" rel="noreferrer">
        ...
        <Paragraph>
          ...
          <a href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking" target="_blank" rel="noreferrer">
        ...
        <List>
          <ListItem>
            ...
            <Paragraph>
              ...
              You to use some of its features. They help to authenticate users andprevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.
            </Paragraph>
          </ListItem>
          <ListItem>
        ...
        <List>
          <ListItem>By email: info@streamline.com</ListItem>
        </List>
      </Container>
    </>
  );
