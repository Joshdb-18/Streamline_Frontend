        ...
        >
          <div className=" flex flex-col justify-center items-start row-start-2 sm:row-start-1">
            <h1 className="text-3xl lg:text-4xl xl:text-5xl font-medium text-black-600 leading-normal">
              Simplify Your Social Media Experience with{" "}
              <strong>Streamline</strong>.
            </h1>
            <p className="text-black-500 mt-4 mb-6">
              Aggregate and manage all your social media feeds in one place.
              Stay connected, engaged, and up-to-date with your friends,
              followers, and favorite content across Facebook, YouTube,
              Instagram, and TikTok. Customize your feed, interact seamlessly,
